...
Source: https://sketchfab.com/3d-models/dalaran-fantasyislandchallenge-51a65d90e9a141f480ba38939ec9a050
Title: Dalaran #FantasyIslandChallenge
*/
...
const Dalaran = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/src/assets/3d/island.glb");
          ...
          >
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="Plane" position={[-123.279, -187.367, -1480.305]}>
                  <mesh
                    name="Plane_Ground_0"
                    castShadow
                    receiveShadow
                ...
                <group name="Circle" position={[-480.077, -188.838, -1371.618]}>
                  <mesh
                ...
                <group name="TowerV3014" position={[6.224, 128.783, -644.174]}>
                  <mesh
                  ...
                  <group name="Object_122">
                    ...
                    >
                      <mesh
                        ...
                        castShadow
                        receiveShadow
                        geometry={nodes.TowerV3003_TowerSet3Building_0.geometry}
                        material={materials.TowerSet3Building}
                      />
                      <mesh
